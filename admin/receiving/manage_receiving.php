                ...
                <div class="row">
                    <?php if (!isset($bo_id)) : ?>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm rounded-0" value="<?php echo isset($po_code) ? $po_code : '' ?>" </div>
                        <?php else : ?>
                            <div class="col-md-6">
                                <label class="control-label text-info">B.O. Code</label>
                                <input type="text" class="form-control form-control-sm rounded-0" value="<?php echo isset($bo_code) ? $bo_code : '' ?>" </div>
                            <?php endif; ?>
                            <div class="col-md-6">
